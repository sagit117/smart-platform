...
/***/ "./src/dictionary lazy recursive ^\\.\\/.*$":
/*!********************************************************!*\
  !*** ./src/dictionary/ lazy ^\.\/.*$ namespace object ***!
  \********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("var map = {\n\t\"./connect-dictionary\": [\n\t\t\"./src/dictionary/connect-dictionary.ts\"\n\t],\n\t\"./connect-dictionary.ts\": [\n\t\t\"./src/dictionary/connect-dictionary.ts\"\n\t],\n\t\"./language\": [\n\t\t\"./src/dictionary/language.ts\"\n\t],\n\t\"./language.ts\": [\n\t\t\"./src/dictionary/language.ts\"\n\t],\n\t\"./ru\": [\n\t\t\"./src/dictionary/ru.ts\"\n\t],\n\t\"./ru.ts\": [\n\t\t\"./src/dictionary/ru.ts\"\n\t],\n\t\"./rus\": [\n\t\t\"./src/dictionary/rus.ts\",\n\t\t\"src_dictionary_rus_ts\"\n\t],\n\t\"./rus.ts\": [\n\t\t\"./src/dictionary/rus.ts\",\n\t\t\"src_dictionary_rus_ts\"\n\t]\n};\nfunction webpackAsyncContext(req) {\n\tif(!__webpack_require__.o(map, req)) {\n\t\treturn Promise.resolve().then(() => {\n\t\t\tvar e = new Error(\"Cannot find module '\" + req + \"'\");\n\t\t\te.code = 'MODULE_NOT_FOUND';\n\t\t\tthrow e;\n\t\t});\n\t}\n\n\tvar ids = map[req], id = ids[0];\n\treturn Promise.all(ids.slice(1).map(__webpack_require__.e)).then(() => {\n\t\treturn __webpack_require__(id);\n\t});\n}\nwebpackAsyncContext.keys = () => (Object.keys(map));\nwebpackAsyncContext.id = \"./src/dictionary lazy recursive ^\\\\.\\\\/.*$\";\nmodule.exports = webpackAsyncContext;\n\n//# sourceURL=webpack://smart-platform/./src/dictionary/_lazy_^\\.\\/.*$_namespace_object?");
